...
namespace MessagePack.Internal
{
    internal static class DynamicObjectTypeBuilder
    {
                ...
                il.EmitIncrementFor(length, forILocal =>
                {
                    ...
                    foreach (DeserializeInfo item in infoList)
                    {
                        if (item.MemberInfo != null)
                        {
                            ...
                            il.EmitCall(MessagePackReaderTypeInfo.CheckNil); //archi-Doc
        ...
        {
            /*Label nilLabel = il.DefineLabel();
            argReader.EmitLdarg();
            il.EmitCall(MessagePackReaderTypeInfo.CheckNil);
...
#pragma warning restore SA1311 // Static readonly fields should begin with upper-case letter
        ...
        internal static class MessagePackReaderTypeInfo
        {
            ...
            internal static readonly MethodInfo CheckNil = typeof(MessagePackReader).GetRuntimeMethod(nameof(MessagePackReader.CheckNil), Type.EmptyTypes); //archi-Doc
